	    ...
	    <ul class="left-side">
	        ...
	        <li class="sub-menu">
		        <ul class="menu">
		            ...
		            <li>
		            	<a target="pageBox" href="<c:url value="/department/list.action" />">
		            		<i class=" fa fa-circle-thin"></i>&nbsp;&nbsp;部门管理
		            	</a>
		            </li>
		            <li>
		            	<a target="pageBox" href="<c:url value="/role/list.action" />">
		            		<i class=" fa fa-circle-thin"></i>&nbsp;&nbsp;角色管理
		            	</a>
		            </li>
		            <li>
		            	<a target="pageBox" href="<c:url value="/user/list.action" />">
